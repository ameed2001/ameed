...
import { 
  ...
  User, LogOut, Menu, X, ChevronDown, Home, Calculator,
  FileText, Phone, Mail, MapPin, Star, Award, Shield
} from 'lucide-react';
import Notifications from './Notifications';
import WhatsAppIcon from '../icons/WhatsAppIcon';

// إنترفيسات TypeScript
interface DateTime {
  time: string;
  date: string;
}
      ...
      <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white backdrop-blur-lg relative overflow-hidden">
        ...
        <div className="container mx-auto flex h-24 items-center justify-between px-4 relative z-10">
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={toggleMenu}
              className="lg:hidden p-3 rounded-xl hover:bg-yellow-500/10 transition-colors border border-yellow-500/30 backdrop-blur-sm"
