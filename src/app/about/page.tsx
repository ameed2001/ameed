        ...
        <Card className="max-w-4xl mx-auto bg-white/95 shadow-xl border border-gray-200/80">
          ...
          <CardContent className="text-lg text-gray-700 text-right leading-relaxed px-6 md:px-10">
            <section className="mb-8">
              <h3 className="text-2xl font-semibold text-app-red mb-3 flex items-center justify-start gap-2">
                <GitCommit /> منصة المحترف لإدارة المشاريع الإنشائية
              </h3>
              <p className="mb-3">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
                <section>
                    <h4 className="text-xl font-semibold text-app-red mb-3 flex items-center justify-start gap-2">
                        <Target /> رسالتنا
                    </h4>
                    <p>
            ...
            <section className="mb-6">
              ...
              <div className="space-y-8">
                ...
                <div data-ai-hint="owner features">
                  <h4 className="text-xl font-bold text-green-600 mb-3 flex items-center justify-start gap-2">
                    <Home /> للمالكين
                  </h4>
                   <ul className="list-disc list-inside space-y-2 text-right">
              ...
              <div className="mt-8" data-ai-hint="admin features">
                  <h4 className="text-xl font-bold text-purple-600 mb-3 flex items-center justify-start gap-2">
                    <Shield /> للمسؤولين
                  </h4>
                   <ul className="list-disc list-inside space-y-2 text-right">
