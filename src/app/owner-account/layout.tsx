...
"use client"; // Needs to be client component for state and useEffect
...
export default function OwnerAccountLayout({ children }: { children: ReactNode }) {
  const [isSidebarOpen, setIsSidebarOpen] = useState(true);

  useEffect(() => {
    if (typeof window !== 'undefined') {
      const savedState = localStorage.getItem('ownerSidebarState'); // Use the same key as OwnerAppLayout
