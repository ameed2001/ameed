      ...
      {selectedProject && (
        <div className="selected-project-details">
          ...
          <div className="tab-content">
            ...
            {/* TODO: أضف قسم "أدوات أخرى" هنا. سيكون هذا القسم مخصصًا للأدوات الإضافية للمالك والتي سيتم تنفيذها في المستقبل. يمكن أن يحتوي مبدئيًا على بطاقة تشير إلى أنها "قريبًا المزيد من الأدوات". */}
            {/* {activeTab === 'more-tools' && (
              <div>
                <h3>أدوات أخرى</h3>
                {/* Placeholder for coming soon content */}
            {/* <p>قريباً المزيد من الأدوات هنا.</p>
              </div>
            )} */}
