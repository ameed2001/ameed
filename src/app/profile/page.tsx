...
// Mock current user data - in a real app, this would come from auth context/state
const currentUser = {
  name: "المستخدم الحالي",
  email: "user@example.com",
  role: "owner", // or "engineer"
};
...
export default function ProfilePage() {
  ...
  const onProfileSubmit: SubmitHandler<ProfileFormValues> = async (data) => {
    ...
    // Update currentUser mock or refetch in real app
  ...
  const onPasswordSubmit: SubmitHandler<PasswordFormValues> = async (data) => {
    ...
    if (data.currentPassword === "oldpassword") { // Mock current password check
