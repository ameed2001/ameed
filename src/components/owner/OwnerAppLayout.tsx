...
// import OwnerSidebar from './OwnerSidebar'; // Temporarily removed
import { useState, useEffect, type ReactNode } from 'react';

export default function OwnerAppLayout({ children }: { children: ReactNode }) {
  // const [isSidebarOpen, setIsSidebarOpen] = useState(true); // Sidebar state not needed for now
  ...
  return (
    <div className="flex flex-col min-h-screen bg-transparent">
      ...
      <div className="flex flex-1 pt-0"> {/* flex-1 allows this div to grow and fill space between header and footer */}
        {/* <OwnerSidebar isOpen={isSidebarOpen} onToggle={toggleSidebar} /> */} {/* Temporarily removed */}
